...
import { HostRoot, HostText, HostComponent } from '../shared/ReactWorkTags';
import { insertInContainerBefore, appendChildToContainer } from '../react-dom/ReactHostConfig';
...
function isHostParent(parent) {
	return parent.tag === HostRoot || parent.tag === HostComponent;
}
