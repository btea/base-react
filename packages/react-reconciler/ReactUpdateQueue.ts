 ...
 */
export const cloneUpdateQueue = <State>(current: Fiber, workInProgress: Fiber): void => {
...
export const processUpdateQueue = <State>(workInProgress: Fiber, props: any, instance: any) => {
	const queue: UpdateQueue<State> = workInProgress.updateQueue as any;
