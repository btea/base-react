...
import { BlockingMode, ConcurrentMode, NoMode, TypeOfMode } from './ReactTypeOfMode';
...
export const createFiber = (tag: WorkTag, pendingProps: unknown, key: string | null, mode: TypeOfMode) => {
